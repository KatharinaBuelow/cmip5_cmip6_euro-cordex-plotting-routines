...
''' make heatmaps for each month average over 30 years
...
# snow
#file_dict = {'Snow':['df_diff_' , 'CMIP6','snw', ('CEU','NEU','MED'), ('ssp126','ssp245','ssp585') ,('_2036-01-01_to_2065-12-31','_2070-01-01_to_2099-12-31'),'_minus_1981-01-01_to_2010-12-31_','mean swe change [mm]',],}
#file_dict = {'Snow':['df_diff_' , 'CMIP6','snw', ('1','2','3','4','5','6','7','8'), ('ssp126','ssp245','ssp585') ,('_2036-01-01_to_2065-12-31','_2070-01-01_to_2099-12-31'),'_minus_1981-01-01_to_2010-12-31_','mean swe change [mm]',],}
#file_dict = {'Snow':['df_diff_' , 'CMIP6','snw', ('deutschland',), ('ssp126','ssp245','ssp585') ,('_2036-01-01_to_2065-12-31','_2070-01-01_to_2099-12-31'),'_minus_1981-01-01_to_2010-12-31_','mean swe change [mm]',],}

# Radiaton
#file_dict = {'Radiation':['df_diff_' , 'CMIP6','rsds', ('CEU','NEU','MED'), ('ssp126','ssp245','ssp585') ,('_2036-01-01_to_2065-12-31','_2070-01-01_to_2099-12-31'),'_minus_1981-01-01_to_2010-12-31_','mean radiation change [w/m**2]',],}
#file_dict = {'Radiation':['df_diff_' , 'CMIP6','rsds', ('1','2','3','4','5','6','7','8'), ('ssp126','ssp245','ssp585') ,('_2036-01-01_to_2065-12-31','_2070-01-01_to_2099-12-31'),'_minus_1981-01-01_to_2010-12-31_','mean radiation change [w/m**2]',],}
#file_dict = {'Radiation':['df_diff_' , 'CMIP6','rsds', ('deutschland',), ('ssp126','ssp245','ssp585') ,('_2036-01-01_to_2065-12-31','_2070-01-01_to_2099-12-31'),'_minus_1981-01-01_to_2010-12-31_','mean radiation change [w/m**2]',],}
...
dt='mon'
datadi=workdir.replace('py_plotting_cmip_cordex','HEATMAP/data/'+MIP+'/monthly/')
print(' ')
print('datafile is read from: ', datadi)
#
# Make Outputdir
#
plotdi=workdir.replace('py_plotting_cmip_cordex','HEATMAP/plots/monthly/')
